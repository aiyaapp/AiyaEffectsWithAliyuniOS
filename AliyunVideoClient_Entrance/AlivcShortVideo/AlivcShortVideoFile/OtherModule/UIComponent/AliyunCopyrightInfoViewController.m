...
//    [scrollView addSubview:contentLabel];
    UITextView *textView = [[UITextView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(topView.frame), ScreenWidth, ScreenHeight-CGRectGetMaxY(topView.frame))];
    textView.text = content;
    textView.textColor = [UIColor whiteColor];
    textView.editable = NO;
    textView.backgroundColor = RGBToColor(35, 42, 66);
