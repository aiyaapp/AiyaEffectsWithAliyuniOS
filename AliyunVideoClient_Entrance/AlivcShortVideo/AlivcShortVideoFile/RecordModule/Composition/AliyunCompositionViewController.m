...
-(void)addAssetToPickView:(AliyunAssetModel *)asset {
    ...
    if (asset.type == AliyunAssetModelMediaTypeVideo) {
        ...
        NSString *path = [[root stringByAppendingPathComponent:[AliyunPathManager uuidString]] stringByAppendingPathExtension:@"gif"];
        ...
        [[AliyunPhotoLibraryManager sharedManager] saveGifWithAsset:asset.asset maxSize:[self maxPhotoSize] outputPath:path completion:^(NSError *error) {
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                cinfo.type = AliyunCompositionInfoTypePhoto;
        ...
        NSString *tmpPhotoPath = [[[AliyunPathManager compositionRootDir] stringByAppendingPathComponent:[AliyunPathManager uuidString] ] stringByAppendingPathExtension:@"jpg"];
