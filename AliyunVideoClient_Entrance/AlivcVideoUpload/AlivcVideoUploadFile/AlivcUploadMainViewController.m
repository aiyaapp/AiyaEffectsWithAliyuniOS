...
- (void)configBaseUI{
    ...
    vodButton.frame = CGRectMake(0, 0, 100, 50);
    [vodButton setTitle:@"VOD列表上传demo" forState:UIControlStateNormal];
    [vodButton sizeToFit];
    [vodButton addTarget:self action:@selector(vodUpload:) forControlEvents:UIControlEventTouchUpInside];
    ...
    ossButton.frame = CGRectMake(0, 0, 100, 50);
    [ossButton setTitle:@"OSS列表上传demo" forState:UIControlStateNormal];
    [ossButton sizeToFit];
    [ossButton addTarget:self action:@selector(ossUpload:) forControlEvents:UIControlEventTouchUpInside];
    ...
    shortButton.frame = CGRectMake(0, 0, 100, 50);
    [shortButton setTitle:@"短视频场景上传demo" forState:UIControlStateNormal];
    [shortButton sizeToFit];
