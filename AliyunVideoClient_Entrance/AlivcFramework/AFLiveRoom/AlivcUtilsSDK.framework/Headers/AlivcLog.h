...
- (void)onAlivcLogCreateFileError:(AlivcLog *)alivcLog path:(NSString *)path errorCode:(NSUInteger)errorCode;

- (void)onAlivcLogRemoveFileError:(AlivcLog *)alivcLog path:(NSString *)path errorCode:(NSUInteger)errorCode;

- (void)onAlivcLogUploadFileError:(AlivcLog *)alivcLog path:(NSString *)path errorCode:(NSUInteger)errorCode;
...
@property (nonatomic, strong) AlivcLogConfig *config;
