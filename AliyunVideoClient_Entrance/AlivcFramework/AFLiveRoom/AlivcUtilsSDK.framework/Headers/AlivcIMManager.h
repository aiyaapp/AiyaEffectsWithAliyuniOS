 ...
 */
- (void)onNotifyConnectSuccess:(AlivcIMManager *)manager;
...
/**
 ...
 @param manager AlivcIMManager
 */
- (void)onNotifyUploadTokenSuccess:(AlivcIMManager *)manager;
 ...
 */
- (void)onNotifyConnectionLost:(AlivcIMManager *)manager token:(NSString *)token error:(NSString *)error;
...
/**
 ...
 @param mode 0:singgapore 1:shanghai
 */
+ (void) AlivcIMSetTestEnvMode:(int)mode;
