...
/**
 server connect recovery
 
 @param pusher AlivcPusher
 */
- (void)onAlivcPusherConnectRecovery:(AlivcPusher *)pusher;
 ...
 */
- (void)onAlivcPusherError:(AlivcPusher *)pusher errorCode:(NSInteger)errorCode errorDetail:(NSInteger)errorDetail;
